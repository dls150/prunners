<?php
  class Categoria_model extends CI_Model{
      ...
      public function get($id=null){
          ...
          $query = $this->db->get_where($this->tabelaNome, array('idcategoria'=>$id));
          return $query->row_array(); //uma unica linha MATCH
      }

      public function remover($id){
          return $this->db->where(array('idcategoria'=>$id))->delete($this->tabelaNome);
      }
      ...
      public function cadastrar($id=null){
          ...
          return $this->db->where(array('idcategoria'=>$id))->update($this->tabelaNome,$registro);
      }
  }
 ?>
